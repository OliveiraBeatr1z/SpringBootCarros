...
@Controller
@RequestMapping("/templates/caminhao")
public class CaminhaoController {
    ...
    public String carregaPaginaFormulario ( Model model){
        ...
        return "templates/caminhao/listagem";
    }
    ////////////////////////
    ...
    public String mostrarFormulario(@RequestParam(required = false) Long id, Model model) {
        ...
        model.addAttribute("templates/caminhao", dto);
        model.addAttribute("templates/marca", marcaService.procurarTodos());
        return "templates/caminhao/formulario";
    }
...
//	}
    ...
    @PostMapping("/salvar")
    public String salvar(@ModelAttribute("templates/caminhao") @Valid AtualizacaoCaminhao dto,
